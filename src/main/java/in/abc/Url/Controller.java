...
import in.abc.model.Repository.IMongoRepository;
...
public class Controller {
	...
	public Optional<in.abc.model.Patient> getValue(@PathVariable("id") int id) {
		Optional<in.abc.model.Patient> findById = imongorepo.findById(id);
